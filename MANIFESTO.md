...
I’ve published [`AGENTS.md`](AGENTS.md) outlining the complete Universal Operational Governance ruleset in this repository. 

Explore the [`/examples`](examples/) directory to see gruesome autopsies of real-world failures (like the bootloader brick) and how the Zero-Trust state machine prevents them.
